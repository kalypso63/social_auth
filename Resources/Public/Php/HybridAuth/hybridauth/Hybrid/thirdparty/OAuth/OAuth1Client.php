...
class OAuth1Client
{
    ...
    */
    public function get($url, $parameters = array(), $content_type = null)
    {
    ...
    */
    public function post($url, $parameters = array(), $body = null, $content_type = null, $multipart = false)
    {
    ...
    */
    public function api($url, $method = 'GET', $parameters = array(), $body = null, $content_type = null, $multipart = false)
    {
    ...
    * Make signed request
    */
    public function signedRequest($url, $method, $parameters, $body = null, $content_type = null, $multipart = false)
    {
    ...
    * Make http request
    */
    public function request($url, $method, $postfields = null, $auth_header = null, $content_type = null, $multipart = false)
    {
